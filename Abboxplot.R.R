### function abboxplot() -  boxplot to show ?? and ?? diversity pattern based on a given dataset and a group factor  ###
# this function is to calculate and visualized ?? and ?? diversity pattern
